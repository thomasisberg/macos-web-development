...
Replace `./macos-web-delopment.sh` with `macos-web-delopment` in all exmples below if you have [self installed macos-web-development](#installing-macos-web-development-self-installation).
