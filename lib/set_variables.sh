...
set_variables ()
{
    ...
    ALL_PHP_VERSIONS=("5.6" "7.0" "7.1" "7.2" "7.3" "7.4" "8.0" "8.1" "8.2" "8.3")
    ALL_ONLY_PHP_FLAGS=($ONLY_PHP_5_6 $ONLY_PHP_7_0 $ONLY_PHP_7_1 $ONLY_PHP_7_2 $ONLY_PHP_7_3 $ONLY_PHP_7_4 $ONLY_PHP_8_0 $ONLY_PHP_8_1 $ONLY_PHP_8_2 $ONLY_PHP_8_3)
    ALL_PHP_FLAGS=($PHP_5_6 $PHP_7_0 $PHP_7_1 $PHP_7_2 $PHP_7_3 $PHP_7_4 $PHP_8_0 $PHP_8_1 $PHP_8_2 $PHP_8_3)
    PHP_VERSIONS=()
