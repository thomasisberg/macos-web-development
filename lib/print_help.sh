...
print_help ()
{
    ...
    echo -e "${C_INFO}--p-common            ${C_EM}Sets options ${C_0}--only-php-8.3 --no-xcode-select"
    echo -e "${C_INFO}--p-minimal           ${C_EM}Sets options ${C_0}--no-mysql --only-php-8-3 --no-xcode-select"
